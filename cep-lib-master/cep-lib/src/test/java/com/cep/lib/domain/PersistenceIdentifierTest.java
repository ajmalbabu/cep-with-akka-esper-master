...
import static com.cep.lib.domain.PersistenceIdentifier.highestSeqNr;
...
public class PersistenceIdentifierTest {
    ...
    public void highestSeqNrOrdered() throws Exception {
        ...
        assertThat(highestSeqNr(ids)).isEqualTo(3);
    ...
    public void highestSeqNrOneElement() throws Exception {
        ...
        assertThat(highestSeqNr(ids)).isEqualTo(1);
    ...
    public void highestSeqNrZeroElement() throws Exception {
        ...
        assertThat(highestSeqNr(ids)).isEqualTo(Long.MIN_VALUE);
